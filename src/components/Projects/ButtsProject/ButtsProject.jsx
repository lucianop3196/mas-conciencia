    ...
    <Container>
      <Grid container rowSpacing={5} columnSpacing={5}>
        ...
        <Grid item xs={12}>
          ...
          >
            Hoy en día las colillas de cigarillo generan miles de toneladas
            anuales de basura y junto a ellas, todas las sustancias tóxicas que
            quedan retenidas en los filtros. Gran parte de las colillas son
            arrojadas al suelo incorporandosé y liberando los tóxicos al medio
            ambiente. Además, el principal material que las compone (acetato de
            celulosa) es un plástico que tarda más de 10 años en degradarse.
          </Box>
        </Grid>
            ...
            <Fade left={true} duration={1700}>
              <Paper elevation={6}>
                ...
                <Box component="ul" sx={{ m: 5, pb: 3 }}>
                  <li>
                    Una sola colilla puede contaminar hasta 50 litros de agua
                    dulce
                  </li>
                  <li>
                    Cuando las colillas se incorporan a los cuerpos de agua, los
                    animales suelen confundirla con comida e ingerirla,
                    produciendo así el desceso de aves, peces y mamíferos
                  </li>
                  <li>
                    En Argentina se fuman 1176 cigarrillos por persona, por años
                  </li>
                  <li>
                    De los mas de 7000 tóxicos que contiene el humo del
                    cigarrilo, unas 70 son sustancias cancerígenas (entre los
                    principales se encuentra el arsénico, benceno, berílio,
                    cadmio, polonio 210)
                  </li>
                </Box>
              </Paper>
          ...
          <Box component="div" sx={{ typography: "body2", gridArea: "obj" }}>
            <Fade right={true} duration={1700}>
              <Paper elevation={6}>
                ...
                <Box component="ul" sx={{ m: 5, pb: 3 }}>
                  <li>
                    Concientizar a la sociedad acerca del impacto que generan
                    las colillas de cigarrillo y cuales son los caudales de
                    desechos al cual nos enfrentamos
                  </li>
                  <li>
                    Dotar a la sociedad de puntos de recolección de colillas{" "}
                  </li>
                  <li>
        ...
        <Grid item xs={6}>
          <Box
            component="span"
            sx={{ typography: "body2", gridArea: "download" }}
          >
            <Fade right={true} duration={1700}>
